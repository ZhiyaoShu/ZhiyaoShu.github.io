...
export default function Contact() {
  return (
    <div>
      <h1 className="mb-2 text-2xl font-semibold tracking-tighter">Contact</h1>
      <ul className="font-sm mt-4 mb-4 flex flex-col space-x-0 space-y-2 gap-3 text-neutral-600 md:flex-row md:space-x-4 md:space-y-0 dark:text-neutral-300">
        <li>
          <a
